...
public class B_InDecrease {
    ...
    public void method1() {
        ...
        // 전위 연산
        System.out.println("전위 연산 적용 전 값 : " + number);
        System.out.println("1회 수행 후 값 : " + ++number);
        System.out.println("2회 수행 후 값 : " + ++number);
        System.out.println("3회 수행 후 값 : " + ++number);
        System.out.println("전위 연산 적용 후 값 : " + number);
        System.out.println();

        // 후위 연산
        System.out.println("후위 연산 적용 전 값 : " + number);
        System.out.println("1회 수행 후 값 : " + number--);
        System.out.println("2회 수행 후 값 : " + number--);
        System.out.println("3회 수행 후 값 : " + number--);
        System.out.println("후위 연산 적용 후 값 : " + number);
        System.out.println();
    }
