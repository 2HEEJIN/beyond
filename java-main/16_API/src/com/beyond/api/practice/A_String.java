...
public class A_String {
    ...
    public void method1() {
        ...
        // 1. concat(String) 메소드는 전달받은 문자열과 원본 문자열을 하나로 합친 새로운 문자열을 리턴한다.
        String concat = str.concat("!!!!");
        // String concat = str + "!!!!"; // concat 메소드를 사용하는 것과 동일한 결과를 만들어 낸다.

        System.out.println(concat);
        System.out.println(str);
        System.out.println();

        // 2. substring(int) 메소드는 매개값으로 전달된 위치에서부터 끝까지의 문자열을 새로 생성해서 리턴한다.
        //    substring(beginIndex, endIndex) 메소드는 매개값의 beginIndex 위치에서부터 endIndex-1 까지의 새로운 문자열 생성해서 리턴한다.
        ...
        // 3. indexOf(String) 전달받은 문자열의 시작 인덱스를 리턴한다.
        ...
        // 4. replace(oldChar, newChar) 메소드는 문자열에서 oldChar를 newChar로 변경된 새로운 문자열을 생성해서 리턴한다.
        ...
        // 5. trim() 메소드는 문자열의 앞뒤 공백을 제거한 새로운 문자열을 생성해서 리턴한다.
        str = " Java ";
        ...
        // 6. split(String) 메소드는 입력받은 구분자로 문자열을 분리하고 배열에 담아서 리턴한다.
        ...
        // 7. valueOf(...) 정적 메소드는 매개값으로 전달받은 값들을 문자열로 변경해서 리턴한다.
    ...
    public void method2() {
        ...
        // 생성자에 문자열을 전달해 주면 문자열 크기 + 16 만큼의 내부 버퍼가 생성된다.
        ...
        // 2. StringBuilder 클레스에서 제공하는 메소드 사용
        ...
        // 2) insert(offset, String) 메소드는 문자열의 offset 위치부터 전달받은 문자열을 추가한다.
        sb.insert(6, "ㅎㅎㅎㅎㅎㅎㅎ");
        ...
        // 3) delete(start, end) 메소드는 start에서 end-1까지의 인덱스에 해당하는 문자열을 삭제한다.
        sb.delete(6, 13);
