...
import com.beyond.search.practicce.Search;
...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println(Search.binarySearch(numbers, 9));
        System.out.println(Search.binarySearch(numbers, 30,0,numbers.length - 1));
        System.out.println();
    }
}
