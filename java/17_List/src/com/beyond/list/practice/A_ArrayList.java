...
public class A_ArrayList {
    public void method1() {
        ...
        // List가 비어있는지 확인하는 메소드이다.
        System.out.println(list.isEmpty());

        // List에 저장된 객체를 모두 삭제하는 메소드이다.
        list.clear();
    ...
    public void method3() {
        ...
        // 타이틀순으로 리스트를 오름차순 정렬 (익명 구현 객체 사용)
...
//        });
        ...
        // 타이틀순으로 리스트를 오름차순 정렬 (람다식 사용)
        Collections.sort(musics, (o1, o2) -> o1.getTitle().compareTo(o2.getTitle()));
